...
export class PrismicRichText extends PrismicTypeBase<PrismicRichTextType, PrismicRichTextPrismicConfig> {
...
export const prismicRichText = (config: PrismicRichTextConfig) => new PrismicRichText(config);
